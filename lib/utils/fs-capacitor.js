...
exports.WriteStream =
  exports.ReadStream =
  exports.ReadAfterReleasedError =
  exports.ReadAfterDestroyedError =
    void 0;
    ...
    (0, fs_1.read)(
      ...
      (error, bytesRead) => {
        ...
        if (this._writeStream._writableState.finished) {
          ...
          if (this._pos < this._writeStream._pos) this._read(n);
          else this.push(null);
          return;
        }
...
class WriteStream extends stream_1.Writable {
  constructor(options) {
    ...
    this._cleanup = (callback) => {
      ...
      (0, fs_1.close)(fd, (closeError) => {
        ...
        (0, fs_1.unlink)(path, (unlinkError) => {
          ...
          callback(
            unlinkError !== null && unlinkError !== void 0
              ? unlinkError
              : closeError
          );
        });
    ...
    (0, crypto_1.randomBytes)(16, (error, buffer) => {
      ...
      this._path = (0, path_1.join)(
        ((_a =
          options === null || options === void 0 ? void 0 : options.tmpdir) !==
          null && _a !== void 0
          ? _a
          : os_1.tmpdir)(),
  ...
  _destroy(error, callback) {
    ...
    if (typeof this._fd === "number" && typeof this._path === "string") {
      this._cleanup((cleanupError) =>
        callback(
          cleanupError !== null && cleanupError !== void 0
            ? cleanupError
            : error
        )
      );
